...
package org.apache.skywalking.oap.server.storage.plugin.es7mq;
...
import org.apache.skywalking.oap.server.storage.plugin.es7mq.base.StorageEs7Installer;
import org.apache.skywalking.oap.server.storage.plugin.es7mq.client.ElasticSearch7Client;
import org.apache.skywalking.oap.server.storage.plugin.es7mq.dao.StorageEs7DAO;
import org.apache.skywalking.oap.server.storage.plugin.es7mq.query.AggregationQueryEs7DAO;

/**
 * The storage provider for ElasticSearch 7 with Mq.
 */
public class StorageModuleEs7WithMqProvider extends ModuleProvider {

    protected final StorageModuleElasticsearch7Config config;
    protected ElasticSearch7Client elasticSearch7Client;

    public StorageModuleEs7WithMqProvider() {
        super();
